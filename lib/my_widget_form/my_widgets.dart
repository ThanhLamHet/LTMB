    ...
    return Scaffold( //man hinh
      ...
      body: Center(child: Column(
        ...
        children: [
          ...
          Text(
            'Văn bản dài bới các tùy chọn khác nhau abvdefasdasdasdaádasdadaddaadasdasdasdasdad',
  ...
  Widget build(BuildContext context){
    return Scaffold( //man hinh
      appBar: AppBar(
        ...
        //
        elevation: 4,
        actions: [                  IconButton(            onPressed: () {              print("search");            },            icon: const Icon(Icons.search),          ),                   IconButton(            onPressed: () {              print("...");            },            icon: const Icon(Icons.more_vert),          ),    IconButton(            onPressed: () {              print("abc");            },            icon: const Icon(Icons.abc),          ),        ],
